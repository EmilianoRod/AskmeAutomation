...
public class AdminsPage extends Base {
    ...
    public WebElement getRowsAdminTable(int i){ return fluentWait(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[2]/div[1]/div[3]/table[1]/tbody[1]/tr["+i+"]/td[1]"));} //i=1 to cant of rows
    ...
    public WebElement getAdminsTable(){ return driver.findElement(table); }
